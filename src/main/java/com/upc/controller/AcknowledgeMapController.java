...
@Controller
public class AcknowledgeMapController {
    @GetMapping("/acknowledgeMap")
    public void AcknowledgeMap(@RequestParam("keyword") String keyword, HttpServletResponse resp)  {
